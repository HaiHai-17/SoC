...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/system_led.v"                                    -work led                                                                              
  vlogan +v2k           "$QSYS_SIMDIR/system_tb/simulation/submodules/system_switch.v"                                 -work switch                                                                           
