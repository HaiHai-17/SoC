...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_width_adapter.sv \
  $QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_address_alignment.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/altera_merlin_burst_adapter.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_sdram.v \
