...
$(MEM_1)_HIERARCHICAL_PATH := sdram1
$(MEM_1)_WIDTH := 16
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: sdram1
sdram1: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
...
$(MEM_2)_HIERARCHICAL_PATH := sdram2
$(MEM_2)_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: sdram2
sdram2: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
