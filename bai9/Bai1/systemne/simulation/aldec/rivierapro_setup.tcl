...
alias com {
  echo "\[exec\] com"
  vlog  "$QSYS_SIMDIR/submodules/systemne_irq_mapper.sv"                            -work irq_mapper                                                                       
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/systemne_rsp_xbar_mux_001.sv"                      -work rsp_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/systemne_rsp_xbar_mux.sv"                          -work rsp_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/systemne_rsp_xbar_demux_003.sv"                    -work rsp_xbar_demux_003                                                               
  vlog  "$QSYS_SIMDIR/submodules/systemne_rsp_xbar_demux.sv"                        -work rsp_xbar_demux                                                                   
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                       -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/systemne_cmd_xbar_mux.sv"                          -work cmd_xbar_mux                                                                     
  vlog  "$QSYS_SIMDIR/submodules/systemne_cmd_xbar_demux_001.sv"                    -work cmd_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/systemne_cmd_xbar_demux.sv"                        -work cmd_xbar_demux                                                                   
  ...
  vlog  "$QSYS_SIMDIR/submodules/systemne_id_router_003.sv"                         -work id_router_003                                                                    
  vlog  "$QSYS_SIMDIR/submodules/systemne_id_router.sv"                             -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/submodules/systemne_addr_router_001.sv"                       -work addr_router_001                                                                  
  vlog  "$QSYS_SIMDIR/submodules/systemne_addr_router.sv"                           -work addr_router                                                                      
